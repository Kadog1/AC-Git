...
Sub LoadInput_Click(str_inputpath As String, str_fileName As String)
    ...
    Set wb = ThisWorkbook
    Set ws_InputAdressdaten = wb.Worksheets("Input Address data")
...
'
    ...
    If check_WBopen(str_inputpath & str_fileName) Then
        ...
        ws_basic_info.range("E3") = ws_Input_basic_info.range("E3").Value
