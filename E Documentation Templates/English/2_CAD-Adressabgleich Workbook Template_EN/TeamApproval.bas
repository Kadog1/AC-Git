...
Sub Transfer(arr_summaryValidated As Variant)
    ...
    Set wb_input = wb.Worksheets("Input Address data")

    pathTemp = "\\Defrnappfl101.ey.net\101fra00010\T\TCC_SB\Z_Archive\eConfirmations\Datenbank\D Dokumentation Templates\3_CAD-Adressabgleich Team Approval_Template_EN.xlsm"
    ...
    Set t_wsInput = wbtemp.Worksheets("Input Address data")
    ...
    templatePath = "\\Defrnappfl101.ey.net\101fra00010\T\TCC_SB\Z_Archive\eConfirmations\Datenbank\B Mail Templates\EN\4_Team_Approval_Template_EN.htm"
    ...
    If arr_summaryValidated(2) <> "" Then
        ...
        newSubject = "FIS involvement required: CAD order [Confirmation] for [Client] / Order number: [OrderNo]"
        ...
        'templatep = "C:\TestLocal\AC adressabgliech\FIS maill project\4_FIS Template_EN.htm"
        templatep = "\\Defrnappfl101.ey.net\101fra00010\T\TCC_SB\Z_Archive\eConfirmations\Datenbank\B Mail Templates\EN\4_FIS Template_EN.htm"
...
Sub createFIScopy(wb As Workbook)
    ...
    lastrowInput = getlastentry(wb.Worksheets("Input Address data"), 2)
