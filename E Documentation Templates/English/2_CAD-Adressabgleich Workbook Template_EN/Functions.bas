...
Sub createVersandlisteFile(wb As Workbook)
    ...
    Set wbVersandliste = Application.Workbooks.Open("\\Defrnappfl101.ey.net\101fra00010\T\TCC_SB\Z_Archive\eConfirmations\Datenbank\D Dokumentation Templates\5_CAD-Adressabgleich Adressen für externe Bestätigungen_Template_ENG.xlsx")
