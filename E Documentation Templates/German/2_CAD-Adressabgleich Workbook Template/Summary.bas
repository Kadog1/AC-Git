...
Sub createSummary_Click()
    ...
    AnswerYes = MsgBox("Summary wird aus allen Tabs erstellt. Bitte stellen Sie sicher, dass alle Tabs bereit sind", vbQuestion + vbYesNo, "User Repsonse")
    ...
    If AnswerYes = vbYes Then
        ...
        arr_ws(5) = "Input Adressdaten"
        arr_ws(6) = "Input Beurteilung"
        arr_ws(7) = "basic_info"
        arr_ws(8) = "Register"
        arr_ws(9) = "CPI Score"
        arr_ws(10) = "TF_FIS"
        ...
        If arr_transferReady(5) <> getlastentry(ActiveWorkbook.Worksheets("Input Adressdaten"), 2) - 13 Then
            MsgBox ("Die Anzahl der Detailsheets stimmt nicht mit der Anzahl der Input Adressdaten über ein!")
            Exit Sub
        End If
        ...
        Else
            MsgBox ("Bitte stellen Sie sicher, dass folgende Tabs finalisiert wurden: " & arr_transferReady(1))
        End If
    ...
    For i = 22 To lastrow
        ...
        Select Case ActiveSheet.Cells(i, 11)
            ...
            Case "û"
                ...
                ActiveWorkbook.Worksheets("TF_X").range("A4") = "Nein"
                ActiveWorkbook.Worksheets("TF_X").range("B4") = "Ja"
            ...
            Case "ü"
                ...
                Else
                    ...
                    If b_okFalse Then
                        ...
                        ActiveWorkbook.Worksheets("TF_ok").range("A4") = "Ja"
                    End If
                End If
