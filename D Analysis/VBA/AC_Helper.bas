...
For I = 1 To c_mails
    ...
    Do While rsOrderbook.EOF = False
        If rsOrderbook("AC_Status") = "" Or rsOrderbook("AC_Status") = "InputDataSent" Or rsOrderbook("AC_Status") = "WaitingforInputData" Or rsOrderbook("AC_Status") = "TeamApprovalSent" Or rsOrderbook("AC_Status") = "TeamApprovalReceived" Or rsOrderbook("AC_Status") = "CanvasDone" Then
